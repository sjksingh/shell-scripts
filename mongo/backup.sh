...
#Examples
#mongorestore /data01/backup/cars_db
#mongorestore /data01/backup/cars_db/users.bson

### Set server settings
HOST="localhost"
PORT="10000" # default mongoDb port is 27017
USERNAME="dba"
PASSWORD="manager"
...
BACKUP_PATH="/data01/mongo/backup" # do not include trailing slash
